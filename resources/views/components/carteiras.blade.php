@if ($ativos->count() === 0)
    <h3 class="text-gray-700">Você não possui ativos no momento.</h3>
@else
    ...
    <div class="bg-white shadow-md rounded-md mb-4 p-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="font-bold">{{ $ativo->nomeAtivo }}</span>

                <a href="{{route('ativo.edit', $ativo->id)}}" class="sm:px-4">
                    <x-link-button
                        x-data=""
                        x-on:click.prevent="$dispatch('open-modal', 'gerenciar')">
                    ...
                    <x-modal name="gerenciar" focusable>
